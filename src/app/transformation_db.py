...
from app.utilities.utils import generate_id, validate_fields
from app.database.query_options import (
    insert_events,
    insert_vehicles,
    insert_operating_period,
    insert_vehicle_event,
)
...
def transform_and_load(data: list):
    ...
    """
    logs = Logs()
    my_db = Database(host=HOST, database=DB, user=USER, password=PASSWORD)
